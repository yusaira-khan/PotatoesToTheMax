!function () {
    ...
    function wt(n, t, e) {
        ...
        var r = pt((.4124564 * n + .3575761 * t + .1804375 * e) / Za), u = pt((.2126729 * n + .7151522 * t + .072175 * e) / Va), i = pt((.0193339 * n + .119192 * t + .9503041 * e) / $a);
    ...
    function Lt(n) { //d3_xhr_fixCallback
        return 1 === n.length ? function (t, e) {
            n(null == t ? e : null)
        } : n
    }

    function Tt() { //d3_xhrHasResponse
        var n = qt(), t = zt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(Qa), Qa = setTimeout(Tt, t)), Ka = 0) : (Ka = 1, tc(Tt))
    }

    function qt() { //d3_timer_mark?
        var n = Date.now();
    ...
    function Pt(n) { //d3_locale_numberFormat
    ...
    function jt() {//d3_date_utc
        this._ = new Date(arguments.length > 1 ? Date.UTC.apply(this, arguments) : arguments[0])
    }

    function Ht(n, t, e) {//d3_time_interval
        function r(t) {
            var e = n(t), r = i(e, 1);
            return r - t > t - e ? e : r
        }
    ...
    function Ft(n) {//d3_time_interval_utc
        return function (t, e) {
            try {
                oc = jt;
                var r = new jt;
    ...
    function Ot(n) {//d3_locale_timeFormat
        function t(n) {
            function t(t) {
    ...
    function It(n, t, e) {//d3_time_formatPad
        var r = 0 > n ? "-" : "", u = (r ? -n : n) + "", i = u.length;
        return r + (e > i ? new Array(e - i + 1).join(t) + u : u)
    }

    function Yt(n) {//d3_time_formatRe
        return new RegExp("^(?:" + n.map(Go.requote).join("|") + ")", "i")
    }

    function Zt(n) {//d3_time_formatLookup
    ...
    function bo(n) {
        ...
        var t = 1, e = n.length, r = n[0], u = r[0], i = r[1], o = [u, u, u, (r = n[1])[0]], a = [i, i, i, r[1]], c = [u, ",", i, "L", Eo(Cs, o), ",", Eo(Cs, a)];
        ...
        return n.event = function (n) {
            n.each(function () {
                ...
                Ls ? Go.select(this).transition().each("start.zoom", function () {
                    ...
                    var e = k[0], r = k[1], u = e / 2, i = r / 2, o = Go.interpolateZoom([(u - S.x) / S.k, (i - S.y) / S.k, e / S.k], [(u - t.x) / t.k, (i - t.y) / t.k, e / t.k]);
                    return function (t) {
                        var r = o(t), c = e / r[2];
    ...
    var js = {
        ...
        se: "nwse-resize",
        sw: "nesw-resize"
    }, Hs = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Fs = ic.format = fc.timeFormat, Os = Fs.utc, Is = Os("%Y-%m-%dT%H:%M:%S.%LZ");
